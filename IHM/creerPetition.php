<?php
// Récupérer l'ID de la pétition depuis l'URL (si nécessaire)
$idPetition = $_GET['id'] ?? '';
?>
<!DOCTYPE html>
<html lang="fr">
...
<body>
    ...
    <section class="featured">
        <div class="container">
            <h2 class="section-title">Ajouter une pétition</h2>
            <p class="section-subtitle">Créez une nouvelle pétition pour une cause importante</p>
            ...
            <?php if (isset($_GET['error'])): ?>
                <div class="alert alert-danger">
                    ...
                    <?php elseif ($_GET['error'] === 'failed'): ?>
                        <i class="fas fa-exclamation-circle"></i> Une erreur s'est produite lors de l'ajout de la pétition. Veuillez réessayer.
                    <?php endif; ?>
                </div>
            <?php endif; ?>
            ...
            <form action="/MAPETITION/Traitement/petition.php?action=creer" method="POST" class="petition-form">
